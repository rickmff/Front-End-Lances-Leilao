...
function Somaiuscula(formato, keypress, objeto) {
    ...
    //OnKeyUp="Somaiuscula('Somaiuscula', window.event.keyCode, 'document.acesso.nome');
    //onkeydown = "this.value = this.value.toUpperCase();cancAcento()"
    //onkeyup = "this.value = this.value.toUpperCase()"
    
}
function closeme()
{
    if(parent.document.getElementById("iframeid"))//to clear the content of iframe if it is there
    {
